<template>
  <div class="linehead cbginput">
    <!-- text -->
    <div v-if="!target[i]" @click="search" class="item_head">
      <svg width="14" height="14" viewBox="0 0 21 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          ...
          stroke-width="2"
        />
        <path d="M15.1318 16.062L19.9996 20.811" stroke="#f84210" stroke-width="2" />
      </svg>
      <span>{{ textLine }}</span>
    </div>
