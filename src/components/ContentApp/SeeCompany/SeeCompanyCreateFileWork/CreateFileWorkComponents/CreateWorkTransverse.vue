      ...
      <div>
        ...
        <div class="cws_box_input_add_competence" v-if="addTransverse === true">
          ...
          <div>
            ...
            <svg
              @click.prevent="addCompetenceTransverse"
            ...
            <!-- close input -->
            <svg
              @click="hiddInputCompetenceTransverse"
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
              viewBox="0 0 24 24"
        ...
        <div class="cws_box_btn_create_new_competence">
          ...
          >
            <path
              ...
              fill="#f84210"
            /></svg
          ><span @click.prevent="seeInputCompetenceTransverse" class="stxxm-r" :class="thColor.textImportant"
...
export default {
  ...
  computed: {
    ...
    //competence transverse of store for create file work
    competenceTransverseSelected: {
      get() {
        return this.$store.state.ApiRom.competenceTransverseSelected;
      },
      set(value) {
        this.$store.commit("ApiRom/selectedCompetenceTransverse", value);
      },
    },

    //competence transverse of api rom
    competenceTransverse: {
      get() {
        return this.$store.getters["ApiRom/competenceTransverse"];
      },
      set(value) {
        this.$store.commit("ApiRom/addNewCompetenceTransverse", value);
      },
    },
  },
  methods: {
    ...
    seeInputCompetenceTransverse() {
      this.addTransverse = !this.addTransverse;
    },

    //for hidd new input
    hiddInputCompetenceTransverse() {
      this.addTransverse = !this.addTransverse;
    },
    ...
    addCompetenceTransverse() {
      if (this.newCompetenceTransverse.libelle != null) {
        this.competenceTransverse = this.newCompetenceTransverse;
        this.addTransverse = !this.addTransverse;
      }
