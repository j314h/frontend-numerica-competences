<template>
  <div>
    <!-- list savoir -->
    <form v-if="isTradeSelected" id="savoirSubmit" @submit.prevent="competenceSavoirValidate">
      <div>
        ...
        <title-cards
          ...
          :themeColor="thColor"
        ></title-cards>
        <div v-for="(competence, i) in competenceOfAppellationSelected.competencesDeBase" :key="i">
          ...
          <div class="cws_box_btn_create_new_competence">
            ...
            >
              <path
                ...
                fill="#f84210"
              /></svg
            ><span @click.prevent="seeInputCompetenceSavoir" class="stxm-r" :class="thColor.textImportant"
